...
The data drill used disposable APAC databases and sanitized fixtures only. Time Travel restored Morning/version 1 after a Night/version 2 mutation. An independent D1 SQL export/import reproduced users, a team, memberships, a roster day and an approved request. Temporary databases and the local SQL file were deleted. Take application exports before structural imports and weekly during the pilot, keep them encrypted for 30 days, and rely on D1 Free Time Travel only for its separate rolling seven-day window.
