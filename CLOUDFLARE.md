...
Custom domain deployed on 2026-09-13. Public DNS resolves it and verified HTTPS reaches Access. The initial NextDNS block cleared on 2026-09-14. Normal DNS/HTTPS smoke, first-user login, persistence, CSRF, foreign-resource denial, deep links and logout now pass. Second-user revalidation is pending; the earlier M2b browser evidence below was collected on the former workers.dev address.
...
| Current version | `4f843406-c818-4f8a-932e-54be59b56f9c` — same M2c candidate; cold CPU gate failed |
